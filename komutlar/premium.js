...
exports.run = async (client, message, args) => {
  ...
  let sahip = '809458743431266376' //Premium verebilicek / alabilecek kişiler
  let log = client.channels.cache.get('814487669777367101') // logların tutulcağı kanal
  ////--------------------------------------------\\\\     
...
.setFooter(`Gelişmiş Premium Sistemi kAYS`)
.setTimestamp())   
}}
////----------------------\\\\ PREMİUM VER ////----------------------\\\\   
  if(args[0] === 'ver') {
