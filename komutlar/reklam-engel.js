...
exports.run = async(client, message, args) => {
  ...
  if (args[0] === 'aç') {
    ...
    message.channel.send(`**Reklam engel başarı ile açıldı <a:tik:813007245440319499>**!`)
  ...
  if (args[0] === 'kapat') {
    ...
    message.channel.send(`**Reklam engel başarı ile kapatıldı <:ReddetmekPng:813007408314056755> **!`)
